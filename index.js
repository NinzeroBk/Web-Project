...
var client = new Client({
    user: 'nizyrewzxtdcsb',
    password: '5b70eb9be8bd83f28847bfb054099caac8b6baa6c14466672277a2478efbf01d',
    database: "d35cdb82f562u4",
...
app.get("*/animated-gallery.css", function (req, res) {
    ...
    let rezScss = ejs.render(sirScss, {
        randNrImgs: randNrImgs
    }); // transmit culoarea catre scss si obtin sirul cu scss-ul compilat
    //console.log(rezScss);
...
app.get(["/", "/index", "/home"], function (req, res) {
    ...
    res.render("pages/index", {
        ip: req.ip,
        staticImgs: obImg.images.slice(0, 12),
        randNrImgs: obImg.images.slice(0, randNrImgs),
        staticImgs_path: obImg.gallery_path,
        current_month: months[current_date.getMonth() - 1]
    });
});
